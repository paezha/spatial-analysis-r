...
<!-- badges: start -->
  [![Launch Rstudio Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/paezha/spatial-analysis-R/master?urlpath=rstudio)
...
> Paez, Antonio (2021). *An Introduction to Spatial Data Analysis and Statistics: A Course in R*. McMaster Invisible Press. 
