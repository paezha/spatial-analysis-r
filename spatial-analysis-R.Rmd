...
```{r ch02-load-tweetrmd-package, include=FALSE}
...
```{r ch02-visualization-example-4, fig.cap= "\\label{fig:visualization-example-4} Example of visualization: Historical map with shading", echo=FALSE}
tweet_screenshot(tweet_url("researchremora", "1479904879984492552"))
```

```{r ch02-visualization-example-5, fig.cap= "\\label{fig:visualization-example-5} Example of visualization: Population density of Madagascar", echo=FALSE}
tweet_screenshot(tweet_url("researchremora", "1473129606383349760"))
```

```{r ch02-visualization-example-6, fig.cap= "\\label{fig:visualization-example-6} Example of visualization: Street map of Kyoto", echo=FALSE}
tweet_screenshot(tweet_url("researchremora", "1469484805033275402"))
```

```{r ch02-visualization-example-7, fig.cap= "\\label{fig:visualization-example-7} Example of visualization: Median household income in California", echo=FALSE}
tweet_screenshot(tweet_url("researchremora", "1464214679136444452"))
```
...
CBD <- ifelse(df_msc$Type == "HH" & df_msc$p.val < 0.05, 1, 0)
Suburb <- ifelse(df_msc$Type == "LL" & df_msc$p.val < 0.05, 1, 0)
```
...
You will also use a custom function that is included in the package `isdas` as follows:
