...
```{r ch02-visualization-example-4-capture, include=FALSE}
webshot("https://mastodon.online/deck/@terence@fosstodon.org/111404498052039281", 
...
```{r ch02-visualization-example-5-capture, include=FALSE}
...
```{r ch02-visualization-example-6-capture, include=FALSE}
...
```{r ch02-visualization-example-7-capture, include=FALSE}
