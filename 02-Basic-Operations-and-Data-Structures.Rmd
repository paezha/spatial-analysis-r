...
```{r symbol-map-with-sized-symbols}
...
```{r load-tweetrmd-package, include=FALSE}
...
```{r visualization-example-4, fig.cap= "\\label{fig:visualization-example-4} Example of visualization: Historical map with shading", echo=FALSE}
tweet_screenshot(tweet_url("researchremora", "1479904879984492552"))
```

```{r visualization-example-5, fig.cap= "\\label{fig:visualization-example-5} Example of visualization: Population density of Madagascar", echo=FALSE}
tweet_screenshot(tweet_url("researchremora", "1473129606383349760"))
```

```{r visualization-example-6, fig.cap= "\\label{fig:visualization-example-6} Example of visualization: Street map of Kyoto", echo=FALSE}
tweet_screenshot(tweet_url("researchremora", "1469484805033275402"))
```

```{r visualization-example-7, fig.cap= "\\label{fig:visualization-example-7} Example of visualization: Median household income in California", echo=FALSE}
