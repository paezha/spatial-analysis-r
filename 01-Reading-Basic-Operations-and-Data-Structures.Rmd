...
```{r visualization-example-1, fig.cap= "\\label{fig:visualization-example-1} Example of visualization: diagram of catchment areas for accessibility analysis (from Paez, Higgins, and Vivona (2018))", echo=FALSE}
knitr::include_graphics(rep("figures/01-Figure-1.png"))
```

```{r visualization-example-2, fig.cap= "\\label{fig:visualization-example-2} Example of visualization: accessibility to family doctors in Hamilton (from Paez, Higgins, and Vivona (2018))", echo=FALSE}
